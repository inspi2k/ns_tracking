...
def get_naver_shopping_results(query, mid, max_pages=1, cursor=1, page_size=50):
...
def update_rank_sheet_batch(sheet_url: str, rank_data: list, sheet_client=None, sheet_name="rank"):
    """
...
if __name__ == "__main__":
    ...
    CREDENTIALS = Credentials.from_service_account_file(
        'python-cglab-9750d891fb6e.json', 
        scopes=SCOPE
    )
